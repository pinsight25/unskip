      ...
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="flex h-16 lg:h-20 items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-6">
            ...
            {/* Mobile Chat Icon with heart icon style badge positioning */}
            <Link
              to="/chats"
            ...
            >
              ...
              {unreadChats > 0 && (
                <span className="absolute -top-2 -right-2 bg-red-500 text-white text-[10px] font-bold rounded-full h-4 w-4 flex items-center justify-center border-2 border-white z-10 shadow-sm">
                  {unreadChats}
                </span>
              )}
            </Link>
