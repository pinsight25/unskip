...
const SellCarNavigation = ({ 
  ...
  return (
    <div className="fixed bottom-16 left-0 right-0 bg-white border-t border-gray-200 p-4 z-50 lg:relative lg:bottom-auto lg:bg-transparent lg:border-t-0 lg:p-0 lg:mt-8 lg:z-auto">
